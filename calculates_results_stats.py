...
def calculates_results_stats(results_dic):
    ...
    print("==> Cuong: number_of_images = ", number_of_images)  
    number_of_dogs_images = 0
    ...
    for key in results_dic:
        ...
        print("==> Cuong: results_stats_dic['n_match'] = ", results_stats_dic['n_match'])  
    ...
    print("==> Cuong: results_stats_dic['n_images'] = ", number_of_images)
    print("==> Cuong: results_stats_dic['n_dogs_img'] = ", number_of_dogs_images)
    results_stats_dic['n_dogs_img'] = number_of_dogs_images
    print("==> Cuong: results_stats_dic['n_match'] = ", results_stats_dic['n_match'])
    print("==> Cuong: results_stats_dic['n_correct_breed'] = ", results_stats_dic['n_correct_breed'])
    print("==> Cuong: results_stats_dic['n_correct_dogs'] = ", results_stats_dic['n_correct_dogs'])

    # calculates number of not-a-dog images using - images & dog images counts
    results_stats_dic['n_notdogs_img'] = (number_of_images - 
    ...
    results_stats_dic['pct_match'] = results_stats_dic['n_match']/number_of_images*100

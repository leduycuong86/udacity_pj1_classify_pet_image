    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
           ...
           for pet_image in in_files:
               ...
               print("\nFilename=", pet_image, "   Label=", pet_label[idx])

           # If filename doesn't already exist in dictionary add it and it's
           # pet label - otherwise print an error message because indicates 
           # duplicate files (filenames)
           print("==> Cuong Pet_label: ", pet_label[idx])
           if in_files[idx] not in results_dic:
              results_dic[in_files[idx]] = [pet_label[idx]]
              #print("==> Cuong: Pet label: ",results_dic[in_files[idx]])              
           else:
               print("** Warning: Duplicate files exist in directory:", 
                     in_files[idx])
           print("Len of result_dict: ", len(results_dic))
